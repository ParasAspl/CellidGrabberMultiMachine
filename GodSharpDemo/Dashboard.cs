    ...
    public partial class Dashboard : MetroForm
    {
       ...
       // string outputFile = @"C:\cell id driver\amar\amar\GodSharpDemo\output.txt";
        ...
        private void scan2GNetwork()
        {
            ...
            ////// (https://stackoverflow.com/questions/55026042/wait-for-response-from-the-serial-port-and-then-send-next-data
            // ln 214)
            //////}
            try
            {
        ...
        public bool establishConnection()
        {
            try
            {
                ...
                //using (var p = new SerialWrapper(port, 9600, SerialWrapper.StopBits.One, SerialWrapper.Parity.None))
                //{
                //    if (!p.Open())
                //    {
                ...
                SerialPort portes = new SerialPort(ports[0], 115200);
            ...
            lock (this)
            {
                if (lockk == false && queue.Count > 0)
                {
                    try
                    {
                        ...
                        serialPort2.BaseStream.WriteAsync(buffer, 0, cmd.Length + 1);
                        lockk = true;
                    }
                    catch (Exception ex)
                    {
        ...
        {
            string dataRec = serialPort2.ReadExisting();
...
{
    //{"status":true,"error":"Licence key has been verified.","mobile":"1234123412","product_key":"64f07a7d4e127","is_used":"0","firstName":"Paras","lastName":"","displayName":"Paras ","urlName":"paras-"}
//  {"status":"1","error":"OK","firstName":"Paras","lastName":"","displayName":"Paras ","urlName":"paras-","mobile":"1234123412","product_key":"64e6f9d2efd58","is_used":"0"}
